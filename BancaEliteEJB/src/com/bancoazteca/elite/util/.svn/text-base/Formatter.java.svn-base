...
//		
		...
		String cuenta = "01720181405560";
		String cuentaFormateada = Formatter.formatSplittedCuenta(cuenta);
		String cuentaFormateadaSinEspacios = formatter.removeSpaces(cuentaFormateada);
		
		System.out.println("cuenta: " + cuenta);
		System.out.println("cuentaFormateada: " + cuentaFormateada);
		System.out.println("cuentaFormateadaSinEspacios: " + cuentaFormateadaSinEspacios);
