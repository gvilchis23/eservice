...
public class B706RegistroRetencionRequestTO extends EjbAlnovaRequestTO {
	
	private static final long serialVersionUID = 3896253630565172749L;
	...
	public B706RegistroRetencionRequestTO(){
