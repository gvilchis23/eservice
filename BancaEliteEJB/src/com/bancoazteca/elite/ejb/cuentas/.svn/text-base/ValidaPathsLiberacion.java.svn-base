...
public class ValidaPathsLiberacion extends CuentasRule implements ValidaPathsERecibos {

	protected ValidaPathsLiberacion(MessageElement messageElement)throws EliteDataException {
