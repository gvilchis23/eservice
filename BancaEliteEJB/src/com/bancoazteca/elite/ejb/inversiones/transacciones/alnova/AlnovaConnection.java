...
public class AlnovaConnection{
	...
	public AlnovaConnection() throws IOException{
		String propertiesName="Alnova.properties";
		if($_url==null){
			PropertiesService properties=PropertiesService.getInstance();	
			$_url=properties.getPropertie(propertiesName,"webservice.alnova.config.url");
			$_branch=properties.getPropertie(propertiesName,"webservice.alnova.config.branch");
			$_entity=properties.getPropertie(propertiesName,"webservice.alnova.config.entity");
			$_user=properties.getPropertie(propertiesName,"webservice.alnova.config.user");
			$_terminal=properties.getPropertie(propertiesName,"webservice.alnova.config.terminal");
			$_chanel=properties.getPropertie(propertiesName,"webservice.alnova.config.chanel");
		}
	}
	...
	public AlnovaResponse executewithURL( AlnovaRequest request,String url )
	{
		final
		Map map;
		final
	...
	public AlnovaResponse execute( AlnovaRequest request ){
		final Map map;
	...
	private void execute( Map map, AlnovaRequest request, String terminal, String extra, String Url )
	{
		final String result;
		final String query;
		final String nombre;
