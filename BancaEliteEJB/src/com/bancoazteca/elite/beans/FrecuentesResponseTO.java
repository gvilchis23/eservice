...
public class FrecuentesResponseTO implements Serializable{

	private static final long serialVersionUID = -862464562324500l;
	private Collection<FrecuentesResponseTO> frecuentes;
	...
	public Collection<FrecuentesResponseTO> getFrecuentes() {
		return frecuentes;
	}
	public void setFrecuentes(Collection<FrecuentesResponseTO> frecuentes) {
