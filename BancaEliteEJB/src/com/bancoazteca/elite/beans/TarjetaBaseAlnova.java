...
public class TarjetaBaseAlnova implements Serializable{
	
	
	private static final long serialVersionUID = 568828454633989654L;
	...
	public String getMostrarNuevoEstado() {
		return mostrarNuevoEstado;
	}
	public void setMostrarNuevoEstado(String mostrarNuevoEstado) {
		this.mostrarNuevoEstado = mostrarNuevoEstado;
	}
	...
	public String getCorteSeptiembre() {
		return corteSeptiembre;
	}
	public void setCorteSeptiembre(String corteSeptiembre) {
		this.corteSeptiembre = corteSeptiembre;
	}
	...
	public String getIndiceTarjeta() {
		return indiceTarjeta;
	}
	public void setIndiceTarjeta(String indiceTarjeta) {
