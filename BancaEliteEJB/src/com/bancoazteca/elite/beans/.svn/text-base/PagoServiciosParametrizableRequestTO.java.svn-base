...
public class PagoServiciosParametrizableRequestTO implements Serializable {	
	...
	private String referenciaParametrizable;
	...
	public String getReferenciaParametrizable() {
		return referenciaParametrizable;
	}
	public void setReferenciaParametrizable(String referenciaParametrizable) {
		this.referenciaParametrizable = referenciaParametrizable;
	}
