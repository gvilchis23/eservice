...
public class AztecaFrecuentesResponseTO implements Serializable{

	private static final long serialVersionUID = -862464562324500l;
	private Collection<AztecaFrecuentesResponseTO> frecuentes;
	...
	private Collection<String> tarjetasFrecuentes;	
	...
	public Collection<String> getTarjetasFrecuentes() {
		return tarjetasFrecuentes;
	}
	public void setTarjetasFrecuentes(Collection<String> tarjetasFrecuentes) {
	...
	public Collection<AztecaFrecuentesResponseTO> getFrecuentes() {
		return frecuentes;
	}
	public void setFrecuentes(Collection<AztecaFrecuentesResponseTO> frecuentes) {
