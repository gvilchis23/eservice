...
//				TODO fin feregrino
	...
	private String cambioAcentosDonativos(String xml) {
		String tmp=null;
		tmp=xml.replaceAll("Donativo FundaciÃ³n Azteca", "Donativo Fundacion Azteca");
		return tmp;
