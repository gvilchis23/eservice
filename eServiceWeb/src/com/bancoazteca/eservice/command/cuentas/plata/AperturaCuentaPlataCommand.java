package com.bancoazteca.eservice.command.cuentas.plata;
...
/**
 * La clase AperturaCuentaPlataCommand es la implementación del comando de aperturas de cuenta 
 * plata, la apertura se realiza invocando al los métodos del ResourceFacadeSL. <br/>
	...
	public Response validacion(Session session) throws ServiceLocatorException, EJBException, CuentasException, SessionExpiredException{
		...
		try{
			...
			if(iteraBeneficiados.hasNext()){
				...
				cuentaPlataRequestTO.setMaternoBenCuatro(beneficiario.getPrimer_apellido());
