								...
								<tr valign="top">
									...
									<td align="center">
										<div id="content" style="height: auto;">
											<h1 align="center">
												Lista de operaciones realizadas con montos
											</h1>
											<table border="5" align="center">
												<thead>
													<tr>
														...
														<td align="center">
															<strong> Operaci&oacute;n Realizada </strong>
														</td>
														<td align="center">
															<strong> Monto </strong>
														</td>
												...
												<logic:iterate id="resultadoConsulta" name="Constantes.RESULTADOS_CONSULTA">
													<tr>
														...
														<td align="left">
															<bean:write name="resultadoConsulta" property="transaccion" />&nbsp;
														</td>
														<td align="left">
															<bean:write name="resultadoConsulta" property="valor" />&nbsp;
														</td>
													</tr>
												</logic:iterate>
											</table>
